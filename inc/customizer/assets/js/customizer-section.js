...
function awpbusinesspress_frontpage_sections_scroll( section_id ){
    ...
    switch ( section_id ) {
        ...
        case 'accordion-section-awpbusinesspress_theme_info_area':
        ...
        case 'accordion-section-awpbusinesspress_theme_project':
        ...
        case 'accordion-section-awpbusinesspress_theme_wooshop':
...
jQuery('body').on('click', '#sub-accordion-panel-awpbusinesspress_frontpage_settings .control-subsection .accordion-section-title', function(event) {
